...
import (
	...
	"github.com/rif/selenium/chrome"
	"github.com/rif/selenium/firefox"
	"github.com/rif/selenium/log"
	"github.com/rif/selenium/sauce"
)
...
func TestDocker(t *testing.T) {
	...
	// passed to go test.
	cmd := exec.Command("docker", "run", fmt.Sprintf("--volume=%s:/code", pathToMount), "--workdir=/code/src/github.com/rif/selenium", "go-selenium", "testing/docker-test.sh")
	if testing.Verbose() {
